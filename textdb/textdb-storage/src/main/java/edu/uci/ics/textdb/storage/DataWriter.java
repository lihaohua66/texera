...
public class DataWriter {
    ...
    public IDField insertTuple(Tuple tuple) throws StorageException {
        ...
        try {
            // if tuple already has _id, use the existing _id
            // if tuple doesn't have _id, generate a random _id field
            IDField idField;
            if (! tuple.getSchema().containsField(SchemaConstants._ID)) {
                ...
                idField = tuple.getField(SchemaConstants._ID, IDField.class);
            }
